...
"""In the special case `n_filters_per_octave=1`, we manually set `ξ=0.39`. That
...
n_filters_per_octave==max_qualityfactor==1 as the Morlet low-frequency corrective
term is no longer negligible."""
default_motherfrequency(class::Morlet, n_filters_per_octave) =
    n_filters_per_octave==1 ? 0.39 : inv(3.0 - exp2(-1.0/n_filters_per_octave))
