...
@test_throws ErrorException
    checkspec(-0.1, log2_length, max_qualityfactor,
              max_scale, motherfrequency, nFilters_per_octave, nOctaves)
# error if ɛ >= 1.0
@test_throws ErrorException
    checkspec(1.0, log2_length, max_qualityfactor,
              max_scale, motherfrequency, nFilters_per_octave, nOctaves)
# error if log2_length < 2
@test_throws ErrorException
    checkspec(ɛ, 1, max_qualityfactor,
              max_scale, motherfrequency, nFilters_per_octave, nOctaves)
# error if max_qualityfactor < 1.0
@test_throws ErrorException
    checkspec(ɛ, log2_length, 0.9,
              max_scale, motherfrequency, nFilters_per_octave, nOctaves)
